 ...
 */
@Module
public abstract class LocalUserPresenterModule {
...
//    abstract LocalUserFragment localUserFragment();
    @FragmentScoped
    @Binds
    abstract SearchContract.View LocalView(LocalUserFragment localUserFragment);

    @FragmentScoped
    @Binds
    abstract SearchContract.Presenter LocalUserPresenter(LocalUserPresenter localUserPresenter);
