...
import com.shineollet.dramancompany.ui.search.local.LocalUserPresenterModule;
import com.shineollet.dramancompany.ui.search.remote.RemoteUserFragment;
import com.shineollet.dramancompany.ui.search.remote.RemoteUserPresenterModule;
...
@Module
public abstract class searchFragmentBindingModule {

    @ContributesAndroidInjector(modules = LocalUserPresenterModule.class)
    abstract LocalUserFragment provideLocalUserFragment();

    @ContributesAndroidInjector(modules = RemoteUserPresenterModule.class)
    abstract RemoteUserFragment provideRemoteUserFragment();
}
